function [ssim, ssim_map, map_obj, composite_mean_vec] = ssim_index_modified(img1, img2, varargin)
%% These comments need update
%%%MM%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%MM%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if find(size(img1) ~= size(img2))
    error('Sizes of images disagree.');
end
if find(K < 0)
    error('K must consist of non-negative numbers.');
end
[H, W] = size(window);
[M, N] = size(img1);
if H * W < 4 || H > M || W > N
