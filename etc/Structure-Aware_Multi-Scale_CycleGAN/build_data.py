...
tf.flags.DEFINE_string('X_input_dir', 'training_set/blur',
                       'X input directory, default: training_set/blur')
tf.flags.DEFINE_string('Y_input_dir', 'training_set/sharp',
                       'Y input directory, default: training_set/sharp')
tf.flags.DEFINE_string('X_output_file', 'training_set/tfrecords/blur.tfrecords',
                       'X output tfrecords file, default: training_set/tfrecords/blur.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'training_set/tfrecords/sharp.tfrecords',
                       'Y output tfrecords file, default: training_set/tfrecords/sharp.tfrecords')
