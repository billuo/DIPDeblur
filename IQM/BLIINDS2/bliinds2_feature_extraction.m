function features = bliinds2_feature_extraction(Img)
    ...
    ori123_rho_L1 = blockproc(Img, [3 3], @oriented123_dct_rho, 'BorderSize', [1,1], 'TrimBorder', false, 'UseParallel', true, 'PadPartialBlocks', true);
    ...
    ori123_rho_L2 = blockproc(Img2, [3 3], @oriented123_dct_rho, 'BorderSize', [1,1], 'TrimBorder', false, 'UseParallel', true, 'PadPartialBlocks', true);
    ...
    ori_rho_L2 = reshape(var(ori123_rho_L2, 0, 3), size(ori123_rho_L2(:, :, 1)));
    ...
    ori123_rho_L3 = blockproc(Img3, [3 3], @oriented123_dct_rho, 'BorderSize', [1,1], 'TrimBorder', false, 'UseParallel', true, 'PadPartialBlocks', true);
    ...
    ori_rho_L3 = reshape(var(ori123_rho_L3, 0, 3), size(ori123_rho_L3(:, :, 1)));
