...
tf.flags.DEFINE_string('checkpoint_dir', 'checkpoints/20190106-1353', 'checkpoints directory path')
tf.flags.DEFINE_string('XtoY_model', 'blur2deblur.pb', 'XtoY model name, default: blur2deblur.pb')
tf.flags.DEFINE_string('YtoX_model', 'deblur2blur.pb', 'YtoX model name, default: deblur2blur.pb')
